...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t3219) {
      cljs.core.t3219 = {};
      cljs.core.t3219 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta3220 = c;
      ...
      cljs.core.t3219.cljs$lang$type = !0;
      cljs.core.t3219.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t3219")
      };
      cljs.core.t3219.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t3219")
      };
      var c = cljs.core.t3219.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t3219.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t3219.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3219.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3220
      };
      cljs.core.t3219.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t3219(this.meta, this.f, b)
      }
    }
    return new cljs.core.t3219(b, a, null)
  }(), b)
};
...
hiccups.runtime.as_str = function(a) {
  return cljs.core.truth_(function() {
    var b = cljs.core.keyword_QMARK_.call(null, a);
    return b ? b : cljs.core.symbol_QMARK_.call(null, a)
  }()) ? cljs.core.name.call(null, a) : "" + cljs.core.str(a)
};
...
hiccups.runtime.normalize_element = function(a) {
  ...
  return cljs.core.map_QMARK_.call(null, c) ? cljs.core.PersistentVector.fromArray([d, cljs.core.merge.call(null, e, c), cljs.core.next.call(null, a)], !0) : cljs.core.PersistentVector.fromArray([d, e, a], !0)
};
hiccups.runtime.render_html = void 0;
...
var kh = {calendar:{}};
kh.calendar.js__GT_unixtime = function(a) {
  return cljs.core.int$.call(null, a.getTime() / 1E3)
};
kh.calendar.unixtime_now = function() {
  return kh.calendar.js__GT_unixtime.call(null, new Date)
};
kh.calendar.unixtime__GT_js = function(a) {
  return new Date(1E3 * a)
};
kh.calendar.unixtime__GT_monthstamp = function(a) {
  a = kh.calendar.unixtime__GT_js.call(null, a);
  a.setHours(0, 0, 0, 0);
  a.setDate(1);
  return kh.calendar.js__GT_unixtime.call(null, a)
};
kh.calendar.unixtime__GT_datestamp = function(a) {
  a = kh.calendar.unixtime__GT_js.call(null, a);
  a.setHours(0, 0, 0, 0);
  return kh.calendar.js__GT_unixtime.call(null, a)
};
kh.calendar.int__GT_str = function(a, b) {
  return[cljs.core.str(cljs.core.apply.call(null, cljs.core.str, cljs.core.repeat.call(null, b - cljs.core.count.call(null, "" + cljs.core.str(a)), "0"))), cljs.core.str(a)].join("")
};
kh.calendar.unixtime__GT_datestring = function(a) {
  var b = kh.calendar.unixtime__GT_js.call(null, a), a = kh.calendar.int__GT_str.call(null, b.getUTCFullYear(), 2), c = kh.calendar.int__GT_str.call(null, 1 + b.getUTCMonth(), 2), b = kh.calendar.int__GT_str.call(null, 1 + b.getUTCDate(), 2);
  return[cljs.core.str(a), cljs.core.str("-"), cljs.core.str(c), cljs.core.str("-"), cljs.core.str(b)].join("")
};
kh.calendar.unixtime__GT_datetimestring = function(a) {
  var b = kh.calendar.unixtime__GT_js.call(null, a), c = kh.calendar.int__GT_str.call(null, b.getUTCHours(), 2), d = kh.calendar.int__GT_str.call(null, b.getUTCMinutes(), 2), b = kh.calendar.int__GT_str.call(null, b.getUTCSeconds(), 2);
  return[cljs.core.str(kh.calendar.unixtime__GT_datestring.call(null, a)), cljs.core.str("T"), cljs.core.str(c), cljs.core.str(":"), cljs.core.str(d), cljs.core.str(":"), cljs.core.str(b), cljs.core.str("Z")].join("")
};
kh.calendar.get_weeknumber = function(a) {
  var a = kh.calendar.unixtime__GT_js.call(null, a), b = cljs.core._EQ_.call(null, a.getDay(), 0) ? 7 : a.getDay();
  a.setHours(0, 0, 0);
  a.setDate(4 + a.getDate() - b);
  b = new Date(a.getFullYear(), 0, 1);
  return Math.ceil(((a - b) / 864E5 + 1) / 7)
};
kh.calendar.datestamps_from = function datestamps_from(b) {
  var c = kh.calendar.unixtime__GT_datestamp.call(null, b);
  return cljs.core.cons.call(null, c, new cljs.core.LazySeq(null, !1, function() {
    return datestamps_from.call(null, 93600 + c)
  }, null))
};
kh.calendar.monthstamps_from = function monthstamps_from(b) {
  var c = kh.calendar.unixtime__GT_monthstamp.call(null, b);
  return cljs.core.cons.call(null, c, new cljs.core.LazySeq(null, !1, function() {
    return monthstamps_from.call(null, 3276E3 + c)
  }, null))
};
kh.calendar.weeknumbers_from = function weeknumbers_from(b) {
  var c = kh.calendar.unixtime__GT_datestamp.call(null, b), b = kh.calendar.get_weeknumber.call(null, c);
  return cljs.core.cons.call(null, b, new cljs.core.LazySeq(null, !1, function() {
    return weeknumbers_from.call(null, 630175 + c)
  }, null))
};
kh.calendar.datetimestring__GT_unixtime = function(a) {
  return cljs.core.int$.call(null, Date.parse(a) / 1E3)
};
kh.calendar.get_first_datestamp_in_calendar = function(a) {
  var a = kh.calendar.unixtime__GT_monthstamp.call(null, a), b = kh.calendar.unixtime__GT_js.call(null, a).getDay(), b = cljs.core._EQ_.call(null, 0, b) ? 7 : b, a = kh.calendar.unixtime__GT_js.call(null, a - 86400 * (b - 1));
  return kh.calendar.js__GT_unixtime.call(null, a)
};
kh.calendar.list_of_months = cljs.core.PersistentVector.fromArray("Januar Februar Mars April Mai Juni Juli August September Oktober November Desember".split(" "), !0);
kh.calendar.list_of_short_days = cljs.core.PersistentVector.fromArray("Man Tir Ons Tor Fre L\u00f8r S\u00f8n".split(" "), !0);
kh.calendar.get_table_header = function(a) {
  a = kh.calendar.unixtime__GT_js.call(null, a);
  return[cljs.core.str(cljs.core._lookup.call(null, kh.calendar.list_of_months, a.getMonth(), null)), cljs.core.str(" "), cljs.core.str(a.getFullYear())].join("")
};
kh.calendar.month__GT_html = function(a) {
  var b = kh.calendar.unixtime__GT_monthstamp.call(null, a), c = kh.calendar.unixtime__GT_datestamp.call(null, kh.calendar.unixtime_now.call(null)), d = kh.calendar.weeknumbers_from.call(null, b), a = kh.calendar.get_first_datestamp_in_calendar.call(null, b), e = cljs.core.take.call(null, 42, kh.calendar.datestamps_from.call(null, a));
  return[cljs.core.str("<table"), cljs.core.str(hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0:data-month", "\ufdd0:id", "\ufdd0:class"], {"\ufdd0:data-month":b, "\ufdd0:id":null, "\ufdd0:class":"calendar"}))), cljs.core.str(">"), cljs.core.str("<tr"), cljs.core.str(""), cljs.core.str(">"), cljs.core.str("<th"), cljs.core.str(' class="monthname" colspan="8"'), cljs.core.str(">"), cljs.core.str(hiccups.runtime.render_html.call(null, kh.calendar.get_table_header.call(null, 
  b))), cljs.core.str("</th>"), cljs.core.str("</tr>"), cljs.core.str('<tr><th> &nbsp; </th><th class="dayname"> Man </th><th class="dayname"> Tir </th><th class="dayname"> Ons </th><th class="dayname"> Tor </th><th class="dayname"> Fre </th><th class="dayname"> L\u00f8r </th><th class="dayname holiday"> S\u00f8n </th></tr>'), cljs.core.str(cljs.core.apply.call(null, cljs.core.str, function g(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var i = cljs.core.first.call(null, a), j = cljs.core.nth.call(null, d, i), l = 7 * i;
          return cljs.core.cons.call(null, [cljs.core.str("<tr"), cljs.core.str(""), cljs.core.str(">"), cljs.core.str("<td"), cljs.core.str(' class="weeknumber"'), cljs.core.str(">"), cljs.core.str(hiccups.runtime.render_html.call(null, j)), cljs.core.str("</td>"), cljs.core.str(cljs.core.apply.call(null, cljs.core.str, function() {
            return function k(a) {
              return new cljs.core.LazySeq(null, !1, function() {
                for(;;) {
                  if(cljs.core.seq.call(null, a)) {
                    var d = cljs.core.first.call(null, a), e = cljs.core._EQ_.call(null, 0, kh.calendar.unixtime__GT_js.call(null, d).getDay()), g;
                    g = (g = d < b) ? g : d >= cljs.core.second.call(null, kh.calendar.monthstamps_from.call(null, b));
                    var h = d < c, i = cljs.core._EQ_.call(null, d, c);
                    return cljs.core.cons.call(null, [cljs.core.str("<td"), cljs.core.str(hiccups.runtime.render_attr_map.call(null, cljs.core.ObjMap.fromObject(["\ufdd0:data-datestamp", "\ufdd0:id", "\ufdd0:class"], {"\ufdd0:data-datestamp":d, "\ufdd0:id":null, "\ufdd0:class":[cljs.core.str("date"), cljs.core.str(e ? " holiday" : null), cljs.core.str(i ? " today" : null), cljs.core.str(cljs.core.truth_(g) ? " outsider" : null), cljs.core.str(h ? " passed" : null)].join("")}))), cljs.core.str(">"), 
                    cljs.core.str(hiccups.runtime.render_html.call(null, kh.calendar.unixtime__GT_js.call(null, d).getDate())), cljs.core.str("</td>")].join(""), k.call(null, cljs.core.rest.call(null, a)))
                  }
                  return null
                }
              }, null)
            }.call(null, cljs.core.take.call(null, 7, cljs.core.drop.call(null, l, e)))
          }())), cljs.core.str("</tr>")].join(""), g.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
  }.call(null, cljs.core.range.call(null, 6)))), cljs.core.str("</table>")].join("")
};
kh.calendar.get_date_cells = function(a, b) {
  var c = kh.calendar.unixtime__GT_datestamp.call(null, b);
  return jayq.core.$.call(null, [cljs.core.str('.date[data-datestamp="'), cljs.core.str(c), cljs.core.str('"]:not(.outsider)')].join(""), a)
};
kh.calendar.register_event = function() {
  var a = null, b = function(a, b, c) {
    return jayq.core.on.call(null, jayq.core.$.call(null, ".date", b), a, c)
  }, c = function(a, b, c, g) {
    return jayq.core.on.call(null, kh.calendar.get_date_cells.call(null, b, g), a, c)
  }, a = function(a, e, f, g) {
    switch(arguments.length) {
      case 3:
        return b.call(this, a, e, f);
...
kh.calendar.register_onclick = cljs.core.partial.call(null, kh.calendar.register_event, "click");
kh.calendar.register_onhold = cljs.core.partial.call(null, kh.calendar.register_event, "hold");
kh.calendar.create_canvas = function() {
  var a = document.createElement("canvas");
  a.height = 100;
  a.width = 100;
  return a
};
kh.calendar.color_canvas = function(a, b) {
  var c = a.width, d = a.height, e = a.getContext("2d");
  cljs.core._EQ_.call(null, 2, cljs.core.count.call(null, b)) ? (e.fillStyle = cljs.core.first.call(null, b), e.beginPath(), e.moveTo(0, 0), e.lineTo(c, 0), e.lineTo(0, d), e.closePath(), e.fill(), e.fillStyle = cljs.core.second.call(null, b), e.beginPath(), e.moveTo(0, d), e.lineTo(c, 0), e.lineTo(c, d), e.closePath(), e.fill()) : cljs.core.doall.call(null, function g(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var i = cljs.core.first.call(null, a), j = cljs.core.nth.call(null, b, i);
          return cljs.core.cons.call(null, function() {
            e.fillStyle = j;
            return e.fillRect(0, d / cljs.core.count.call(null, b) * i, c, d / cljs.core.count.call(null, b))
...
kh.calendar.set_background_colors = function() {
  var a = null, b = function(a, b) {
    return jayq.core.css.call(null, kh.calendar.get_date_cells.call(null, a, b), "\ufdd0:background", "none")
  }, c = function(b, c, f) {
    var g = cljs.core.string_QMARK_.call(null, f) ? cljs.core.list.call(null, f) : f;
    if(cljs.core.empty_QMARK_.call(null, g)) {
      return a.call(null, b, c)
    }
    var f = kh.calendar.color_canvas.call(null, kh.calendar.create_canvas.call(null), g), h = [cljs.core.str("url("), cljs.core.str(f.toDataURL("image/png")), cljs.core.str(")")].join("");
    return cljs.core.doall.call(null, function j(a) {
      return new cljs.core.LazySeq(null, !1, function() {
        for(;;) {
          if(cljs.core.seq.call(null, a)) {
            var b = cljs.core.first.call(null, a);
            return cljs.core.cons.call(null, function() {
              jayq.core.attr.call(null, jayq.core.$.call(null, b), "\ufdd0:data-colors", cljs.core.apply.call(null, cljs.core.str, cljs.core.map.call(null, function(a) {
                return[cljs.core.str(a), cljs.core.str(" ")].join("")
              }, g)));
              return jayq.core.css.call(null, jayq.core.$.call(null, b), cljs.core.ObjMap.fromObject(["\ufdd0:background-image", "\ufdd0:background-size"], {"\ufdd0:background-image":h, "\ufdd0:background-size":"100% 100%"}))
            }(), j.call(null, cljs.core.rest.call(null, a)))
          }
          return null
        }
      }, null)
    }.call(null, kh.calendar.get_date_cells.call(null, b, c)))
  }, a = function(a, e, f) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, e);
...
kh.calendar.add_background_color = function(a, b, c) {
  var d = cljs.core.string_QMARK_.call(null, c) ? cljs.core.list.call(null, c) : c;
  return cljs.core.doall.call(null, function f(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var c = cljs.core.first.call(null, a), i = clojure.string.split.call(null, jayq.core.attr.call(null, jayq.core.$.call(null, c), "\ufdd0:data-colors"), /\s/), i = cljs.core.remove.call(null, cljs.core.empty_QMARK_, cljs.core.concat.call(null, i, d));
          return cljs.core.cons.call(null, kh.calendar.set_background_colors.call(null, c.parentNode, b, i), f.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
  }.call(null, kh.calendar.get_date_cells.call(null, a, b)))
};
kh.calendar.add_class = function(a, b, c) {
  return cljs.core.doall.call(null, function e(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var b = cljs.core.first.call(null, a);
          return cljs.core.cons.call(null, jayq.core.add_class.call(null, jayq.core.$.call(null, b), c), e.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
...
kh.calendar.set_text_color = function() {
  var a = null, b = function(a, b) {
    return jayq.core.css.call(null, kh.calendar.get_date_cells.call(null, a, b), "\ufdd0:color", "inherit")
  }, c = function(a, b, c) {
    return jayq.core.css.call(null, kh.calendar.get_date_cells.call(null, a, b), "\ufdd0:color", c)
  }, a = function(a, e, f) {
    switch(arguments.length) {
      case 2:
        return b.call(this, a, e);
...
kh.calendar.load_data = function(a, b) {
  return cljs.core.dorun.call(null, function d(b) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, b)) {
          var f = cljs.core.first.call(null, b), f = cljs.core.seq_QMARK_.call(null, f) ? cljs.core.apply.call(null, cljs.core.hash_map, f) : f, g = cljs.core._lookup.call(null, f, "\ufdd0:class", null), h = cljs.core._lookup.call(null, f, "\ufdd0:color", null), i = cljs.core._lookup.call(null, f, "\ufdd0:end", null), j = cljs.core._lookup.call(null, f, "\ufdd0:start", null);
          cljs.core._lookup.call(null, f, "\ufdd0:title", null);
          return cljs.core.cons.call(null, cljs.core.dorun.call(null, function() {
            var b = g, d = h, e = i;
            return function p(f) {
              return new cljs.core.LazySeq(null, !1, function() {
                for(;;) {
                  if(cljs.core.seq.call(null, f)) {
                    ...
                    return g < kh.calendar.unixtime__GT_datestamp.call(null, kh.calendar.datetimestring__GT_unixtime.call(null, e)) ? cljs.core.cons.call(null, function() {
                      cljs.core.not.call(null, clojure.string.blank_QMARK_.call(null, d)) && kh.calendar.add_background_color.call(null, a, g, d);
                      return cljs.core.not.call(null, clojure.string.blank_QMARK_.call(null, b)) ? kh.calendar.add_class.call(null, a, g, b) : null
                    }(), p.call(null, cljs.core.rest.call(null, f))) : null
                  }
                  return null
                }
              }, null)
            }.call(null, kh.calendar.datestamps_from.call(null, kh.calendar.datetimestring__GT_unixtime.call(null, j)))
...
kh.calendar.load_events_from_url = function(a, b) {
  return jayq.core.ajax.call(null, a, cljs.core.ObjMap.fromObject(["\ufdd0:data-type", "\ufdd0:success"], {"\ufdd0:data-type":"text/clojure", "\ufdd0:success":b}))
};
kh.calendar.data = cljs.core.atom.call(null, cljs.core.PersistentVector.EMPTY);
kh.calendar.list_events_on_date = function(a) {
  return cljs.core.apply.call(null, cljs.core.str, cljs.core.map.call(null, function(a) {
    return cljs.core.empty_QMARK_.call(null, a) ? null : [cljs.core.str(a), cljs.core.str("\n")].join("")
  }, function c(d) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, d)) {
          var e = cljs.core.first.call(null, d), e = cljs.core.seq_QMARK_.call(null, e) ? cljs.core.apply.call(null, cljs.core.hash_map, e) : e, f = cljs.core._lookup.call(null, e, "\ufdd0:end", null), g = cljs.core._lookup.call(null, e, "\ufdd0:start", null), e = cljs.core._lookup.call(null, e, "\ufdd0:title", null);
          return cljs.core.cons.call(null, cljs.core.truth_(function() {
            var c = a >= kh.calendar.unixtime__GT_datestamp.call(null, kh.calendar.datetimestring__GT_unixtime.call(null, g));
            return c ? a < kh.calendar.unixtime__GT_datestamp.call(null, kh.calendar.unixtime__GT_datestamp.call(null, kh.calendar.datetimestring__GT_unixtime.call(null, f))) : c
          }()) ? e : null, c.call(null, cljs.core.rest.call(null, d)))
        }
        return null
      }
    }, null)
  }.call(null, cljs.core.deref.call(null, kh.calendar.data))))
};
kh.calendar.click = function(a) {
  a = jayq.core.attr.call(null, jayq.core.$.call(null, a.currentTarget), "data-datestamp");
  a = kh.calendar.list_events_on_date.call(null, a);
  return cljs.core.not.call(null, clojure.string.blank_QMARK_.call(null, a)) ? window.alert(a) : null
};
kh.calendar.init = function(a) {
  document.querySelector(a).innerHTML = cljs.core.apply.call(null, cljs.core.str, function c(a) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
        if(cljs.core.seq.call(null, a)) {
          var e = cljs.core.first.call(null, a);
          return cljs.core.cons.call(null, kh.calendar.month__GT_html.call(null, e), c.call(null, cljs.core.rest.call(null, a)))
        }
        return null
      }
    }, null)
  }.call(null, cljs.core.take.call(null, 12, kh.calendar.monthstamps_from.call(null, kh.calendar.unixtime_now.call(null)))));
  kh.calendar.load_events_from_url.call(null, "server.php", function(a) {
    cljs.core.reset_BANG_.call(null, kh.calendar.data, a);
    return kh.calendar.load_data.call(null, document, cljs.core.deref.call(null, kh.calendar.data))
  });
  return kh.calendar.register_onclick.call(null, document, kh.calendar.click)
};
goog.exportSymbol("kh.calendar.init", kh.calendar.init);
